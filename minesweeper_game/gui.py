...
QUESTION_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "question.png")
BOOM_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "boom.png")
EMPTY_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "blue_circle.png")
NUMBER_PATHS = [join(minesweeper_game.PACKAGE_IMGS_PATH, "zero.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "one.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "two.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "three.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "four.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "five.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "six.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "seven.png"),
                join(minesweeper_game.PACKAGE_IMGS_PATH, "eight.png")]
WIN_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "win.png")
LOSE_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "lose.png")
CONTINUE_PATH = join(minesweeper_game.PACKAGE_IMGS_PATH, "continue.png")
...
class RemoteControlThread(QtCore.QThread):
    ...
    def run(self):
        ...
        solver = Solver(self.ms_game.board_width, self.ms_game.board_height, self.ms_game.num_mines)
...
class RemoteControlThreadMLModel(QtCore.QThread):
    """Thread that covers remote control."""
    ...
    def run(self):
        ...
        while self.ms_game.game_status  == 2:
            ...
            self.transfer.emit("click: " + str(choice[1]) + ", " + str(choice[0]))
